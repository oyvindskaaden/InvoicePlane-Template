...
<body>
	...
	<htmlpageheader name="header">
		...
		<div id="toptextR">
			<h2 style="color:green;"><b><?php echo trans('invoice') . ' ' . $invoice->invoice_number; ?></b></h2>
			<table class="info">
				<tr>
	...
	<div>
		...
		<main>
			...
			<div id="project">
				...
				<?php } ?>
				<br><br>
				<b style="font-size: x-large;color:green;"><?php _trans('paid'); ?></b><br>
				...
				Viktig at betalingen markeres med: <b style="color:green;"><?php echo $invoice->invoice_number; ?></b> (fakturanr.)
				<hr>
				<div id="price">
			...
			<div class="sign" style="font-size: large; text-align: right;">
				Viktig at betalingen markeres med: <b style="color:green;"><?php echo $invoice->invoice_number; ?></b><br>
				
				Betales til kontonr: <b><?php echo $custom_fields['user']['Kontonr']?></b><br>
				<b style="color:green;">Sum å betale: <?php echo format_currency($invoice->invoice_balance); ?></b><br><br>
